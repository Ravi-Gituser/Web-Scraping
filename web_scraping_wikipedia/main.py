...
#The applications are recommender systems, chatbots and NLP, sentiment analysis,
#data visualization,
#market research
...
#Method definition to get the words.
def getWordList(url):
    word_list = []
    #raw data is sourced from the url.
...
#Method to clean word with regex.
def clean_word(word):
    cleaned_word = re.sub('[^A-Za-z]+', '', word)
    return cleaned_word

# Creating the frequency list of all words in the array.
